...
list1 = [1,2,3,4,5,'a','Neeharika',"Kujur",True]  #list type of object with data
...
#%% for horizontal line 
tuple1
type(tuple1) #type is used to show the kind of data structure type 
#%%
...
for i in list1:    print('Neeharika ', i + 6)
